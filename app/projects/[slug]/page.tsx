  ...
  return (
    <article className="mx-auto max-w-4xl px-6 pb-28 pt-28">
      ...
      <header className="mt-10">
        ...
        <h1 className="mt-3 font-serif text-[clamp(2.5rem,8vw,4.5rem)] italic leading-[0.95] text-cream">
          {project.title}
        </h1>
      ...
      {/* Hero visual placeholder — TODO: add screenshot */}
      <div className="mt-12 flex aspect-[16/8] w-full items-center justify-center border border-border bg-surface">
            ...
            <div className="grid grid-cols-1 gap-px border border-border bg-border sm:grid-cols-3">
              {caseStudy.results.map((r) => (
                <div key={r.label} className="bg-surface px-5 py-7 text-center">
                  <p className="font-serif text-3xl italic text-gold">{r.value}</p>
